...
export const metadata: Metadata = {
  title: 'Restrooms in Irvine, CA | Nearby Bathrooms & Access Info | FlushPin',
  description: 'Find nearby bathrooms and restroom access information in Irvine, California. Community-submitted restroom locations, access notes, and reported accessibility details.',
  alternates: { canonical: 'https://www.flushpin.com/restrooms/orange-county/irvine' },
  openGraph: {
    title: 'Restrooms in Irvine, CA | FlushPin',
    description: 'Find nearby restrooms and bathroom access information in Irvine, CA.',
    url: 'https://www.flushpin.com/restrooms/orange-county/irvine',
    siteName: 'FlushPin',
    type: 'website',
  },
}
...
const faqs = [
  {
    q: 'Where can I find public restrooms in Irvine?',
    a: 'FlushPin shows community-submitted restroom locations across Irvine including restaurants, cafes, and shopping centers like Irvine Spectrum Center. Open the app to find options near your current location.',
  },
  {
    q: 'Does FlushPin show restroom access codes in Irvine?',
    a: 'Yes. FlushPin displays community-submitted restroom access codes for many Irvine locations. Codes may change — always verify when you arrive.',
  },
  {
    q: 'Are there accessible restrooms in Irvine on FlushPin?',
  ...
  {
    q: 'Is FlushPin useful for delivery drivers in Irvine?',
    a: 'Yes. Many Irvine listings are tagged as delivery driver friendly. Filter by this in the app to find driver-accessible restrooms near your route.',
  },
]
...
export default function IrvinePage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Irvine', item: 'https://www.flushpin.com/restrooms/orange-county/irvine' },
    ],
  }
      ...
      <main className="min-h-screen bg-white text-gray-900">
        <div className="mx-auto max-w-3xl px-5 py-10 pb-24">
          ...
          <nav className="mb-8 text-sm text-gray-500">
            ...
            <span className="mx-2">/</span>
            <span className="text-gray-900">Irvine</span>
          </nav>

          <section className="mb-14">
            <h1 className="text-4xl font-extrabold leading-tight mb-5">
              Find Restrooms in Irvine, CA
            </h1>
            <p className="text-lg text-gray-600 leading-relaxed mb-8">
              Looking for a nearby bathroom in Irvine? FlushPin shows community-submitted
              restroom locations, access notes, and reported accessibility details across
              restaurants, cafes, and shopping centers like Irvine Spectrum Center.
            </p>
          ...
          <section className="mb-14">
            <h2 className="text-2xl font-bold mb-5">What you can find in Irvine</h2>
          ...
          <section className="mb-14">
            ...
            <div className="space-y-3">
              {[
                ...
                { href: '/restrooms/orange-county/anaheim', label: 'Restrooms in Anaheim' },
                { href: '/restrooms/orange-county/costa-mesa', label: 'Restrooms in Costa Mesa' },
                { href: '/restrooms/orange-county/newport-beach', label: 'Restrooms in Newport Beach' },
          ...
          <div className="rounded-3xl border border-gray-200 bg-gray-50 p-10 text-center">
            <h2 className="text-2xl font-extrabold text-gray-900 mb-3">Need a restroom in Irvine?</h2>
